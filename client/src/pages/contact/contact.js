    ...
    return (
        <main id='contact'>
            ...
            <section className='location'>
                ...
                />
                <ul>
                    <li><FontAwesomeIcon icon={faLocationDot} size="lg" /> <span>Al Wahda Residential Tower - 8 Al Wahdah St - Al Nahyan - Zone 1 - Abu Dhabi</span></li>
                    <li><FontAwesomeIcon icon={faClock} size="lg" /> <span>Open 7AM - 11:30 PM</span></li>
                    <li><FontAwesomeIcon icon={faPhone} size="lg" /> <span>0507604817</span></li>
                </ul>
            </section>     
        </main>
    );
